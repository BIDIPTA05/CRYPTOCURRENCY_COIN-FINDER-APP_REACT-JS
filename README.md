## The Crypto Coin Finder App is use to display various Crypto coins and their prices along with symbol, alltimehigh, 24hr price, volume , marketcap etc. The Coin details are fetch from CoinGecko API. 
